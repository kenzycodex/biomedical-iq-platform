          ...
          <div className="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
            ...
            <div className="mt-4">
              ...
              <div className="mx-auto max-w-180">
                ...
                <p className="mt-4.5">
                  KenTech Impact is a dynamic startup at the intersection of technology and design, driven by a vision to redefine creativity on a global scale. Our mission is to deliver unparalleled software development, graphic and illustration design, web development, digital marketing, custom creativity and other tech and designs innovative solutions. We are at a crucial juncture, seeking associates who share our passion to propel KenTech Impact to new heights. Our foundation rests on a commitment to creativity, quality, and affordability. By fostering a culture of innovation and collaboration, we aim to become a pioneering force in the tech and design industry. As an associate, your support is integral to our journey.
                </p>
              </div>
