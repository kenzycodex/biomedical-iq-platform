        ...
        <div className="flex flex-wrap items-center">
          ...
          <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">              
              ...
              <span className="mb-8 block font-medium">We&#39;ve sent a 6-digit code to your email. Please enter it below to verify your identity</span>
                ...
                <div className="mt-6 text-center">
                  <p className="text-sm text-gray-600 dark:text-gray-400">
                    ...
                    <button
                      ...
                      className="text-sm font-medium text-primary hover:text-primary-dark focus:outline-none focus:underline transition ease-in-out duration-150"
                   >
