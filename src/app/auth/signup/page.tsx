                  ...
                  <div className="relative">
                    ...
                    <span className="absolute right-4 top-4">
                      ...
                      >
                        <g opacity="0.5">
                          <path
                            d="M6.62 10.79A15.051 15.051 0 0 0 13.21 17.37L15.71 14.87C16.1 14.48 16.72 14.34 17.2 14.51C18.74 15.07 20.46 15.36 22.25 15.36C22.66 15.36 23 15.71 23 16.13V20.5C23 20.78 22.78 21 22.5 21C10.85 21 3 13.15 3 1.5C3 1.22 3.22 1 3.5 1H7.87C8.29 1 8.64 1.34 8.64 1.75C8.64 3.54 8.93 5.26 9.49 6.8C9.66 7.28 9.51 7.9 9.12 8.29L6.62 10.79Z"
                            fill="currentColor"
                          />
                        </g>
                      </svg>
